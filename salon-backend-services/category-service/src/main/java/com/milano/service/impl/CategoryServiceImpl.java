...
public class CategoryServiceImpl implements CategoryService {
    ...
    @Override
    public void createCategory(CategoryRequestDTO categoryRequestDTO, SalonRequestDTO salonRequestDTO) {
        categoryRepo.save(categoryMapper.toCategory(categoryRequestDTO, salonRequestDTO));
    }

    @Override
    public void deleteCategory(UUID id, UUID salonId) {

        Category category = categoryRepo.findById(id)
                .orElseThrow(() ->
                        new EntryNotFoundException("Category not found for provided id"));
    ...
    public PagedResponseDTO<CategoryResponseDTO> getAllCategories(String searchText, int page, int size) {
        ...
        return PagedResponseDTO.<CategoryResponseDTO>builder()
